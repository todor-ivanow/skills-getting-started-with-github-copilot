...
activities.update({
    "Soccer Team": {
        "description": "Competitive soccer team practicing fundamentals and teamwork",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 22,
        "participants": ["ryan@mergington.edu", "ava@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Pickup games and drills for all skill levels",
    ...
    "Debate Club": {
        "description": "Practice debate formats, public speaking, and critical thinking",
        "schedule": "Thursdays, 3:45 PM - 5:15 PM",
        "max_participants": 16,
        "participants": ["oliver@mergington.edu", "ava2@mergington.edu"]
    },
    "Science Club": {
        "description": "Hands-on experiments, guest speakers, and science fairs",
        "schedule": "Wednesdays, 3:30 PM - 4:30 PM",
        "max_participants": 20,
        "participants": ["elijah@mergington.edu", "emma2@mergington.edu"]
    }
})
